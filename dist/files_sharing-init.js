...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileAction({
  ...
  displayName(nodes) {
    ...
    if (shareTypes.length > 0 || ownerId && ownerId !== ((_getCurrentUser = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_9__.getCurrentUser)()) === null || _getCurrentUser === void 0 ? void 0 : _getCurrentUser.uid)) {
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_sharing', 'Shared');
    }
    return '';
  },
  title(nodes) {
    var _node$attributes3, _node$attributes4, _node$attributes5, _getCurrentUser2;
    const node = nodes[0];
    ...
    // Mixed share types
    if (Array.isArray((_node$attributes5 = node.attributes) === null || _node$attributes5 === void 0 ? void 0 : _node$attributes5['share-types'])) {
    ...
    if (ownerId && ownerId !== ((_getCurrentUser2 = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_9__.getCurrentUser)()) === null || _getCurrentUser2 === void 0 ? void 0 : _getCurrentUser2.uid)) {
  ...
  iconSvgInline(nodes) {
    var _node$attributes6, _node$attributes7, _node$attributes8, _getCurrentUser3;
    const node = nodes[0];
    const shareTypes = Object.values((node === null || node === void 0 || (_node$attributes6 = node.attributes) === null || _node$attributes6 === void 0 ? void 0 : _node$attributes6['share-types']) || {}).flat();
    // Mixed share types
    if (Array.isArray((_node$attributes7 = node.attributes) === null || _node$attributes7 === void 0 ? void 0 : _node$attributes7['share-types'])) {
    ...
    const ownerId = node === null || node === void 0 || (_node$attributes8 = node.attributes) === null || _node$attributes8 === void 0 ? void 0 : _node$attributes8['owner-id'];
    if (ownerId && ownerId !== ((_getCurrentUser3 = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_9__.getCurrentUser)()) === null || _getCurrentUser3 === void 0 ? void 0 : _getCurrentUser3.uid)) {
      return generateAvatarSvg(ownerId);
    }
    return _mdi_svg_svg_account_plus_svg_raw__WEBPACK_IMPORTED_MODULE_4__;
  },
  enabled(nodes) {
    var _node$attributes9, _node$attributes10, _getCurrentUser4;
    if (nodes.length !== 1) {
      return false;
    }
    const node = nodes[0];
    const ownerId = node === null || node === void 0 || (_node$attributes9 = node.attributes) === null || _node$attributes9 === void 0 ? void 0 : _node$attributes9['owner-id'];
    const isMixed = Array.isArray((_node$attributes10 = node.attributes) === null || _node$attributes10 === void 0 ? void 0 : _node$attributes10['share-types']);
    ...
    if (ownerId && ownerId !== ((_getCurrentUser4 = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_9__.getCurrentUser)()) === null || _getCurrentUser4 === void 0 ? void 0 : _getCurrentUser4.uid)) {
      return true;
    }
...
/******/ })()
;
//# sourceMappingURL=files_sharing-init.js.map?v=389e96fe992d92f3bdbf